...
const HomeContent = () => {
  return (
    <div
      className="px-5 lg:py-14 col-span-full lg:col-span-8 overflow-auto max-h-full scroll-smooth"
      id="documentation"
    >
      <h1 className="text-2xl text-center lg:text-6xl lg:text-left font-poppins md:pl-10 font-extrabold text-gray-800 my-10">
        Documentation
      </h1>
...
const Element = ({
  ...
  return (
    <div
      className="flex flex-col gap-3.5 lg:py-14 py-4 lg:px-10 border-b-2 scroll-m-16"
      id={id}
    >
      <h1 className="text-xl lg:text-3xl underline underline-offset-8 font-semibold tracking-wide font-poppins text-gray-700">
        {title}
      </h1>
      ...
      <div className="rounded-xl overflow-hidden">
        <div className="flex justify-between bg-gray-600 text-gray-300 font-poppins items-center py-1.5 px-5 text-sm font-medium">
          ...
          <span
            className={`p-1 ${
              copy ? "bg-green-500" : "bg-gray-500 hover:bg-purple-500"
            } transition-all rounded-lg text-white cursor-pointer`}
            onClick={handleCopy}
          >
